...
App.Models.ConversationIds = App.Models.EmailBoxModel.extend({
	
	// Returns ConvomailConversation._ids
	// - special kind of caching
	// cacheType: 'ids'

	modelName: 'ConvomailConversation',
	internalModelName: 'ConversationIds',
	fields: ['_id']
...
App.Models.Conversation = App.Models.EmailBoxModel.extend({
	
	modelName: 'ConvomailConversation',
	internalModelName: 'Conversation',
